...
from controllers.estructuras import users, productos, empleados, actividades
from controllers.usercontroller import Blueprint_user, precargar_usuarios
from controllers.productoscontroller import Blueprint_producto, precargar_productos
from controllers.empleadoscontroller import Blueprint_empleado,  precargar_empleados
from controllers.actividadescontroller import Blueprint_actividad, precargar_actividades
